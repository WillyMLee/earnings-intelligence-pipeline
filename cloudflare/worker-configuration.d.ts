/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.earnings.jsonc cloudflare/worker-configuration.d.ts` (hash: 9c89f05cc763ed8b6071aa06b74adb89)
// Runtime types generated with workerd@1.20260815.1 2026-08-20 nodejs_compat
interface __BaseEnv_Env {
	ALPHA_VANTAGE_API_KEY: "demo";
	CONVEX_URL: "https://honorable-goldfish-309.convex.cloud";
	DRY_RUN: "false";
	ENVIRONMENT: "production";
	NATIVE_SENDS_ENABLED: "true";
	EMAIL_PROVIDER: "agentmail";
	TINYFISH_LANGUAGE: "en";
	TINYFISH_LOCATION: "US";
	OPENAI_WEB_SEARCH_MODEL: "gpt-4o-mini";
	EARNINGS_TIME_ZONE: "America/New_York";
	SCHEDULE_VERSION: "earnings-cloudflare-v2";
	RELEASE_TAG: "2026-08-20-cloudflare-cutover-v1";
	AGENTMAIL_API_KEY: string;
	AGENTMAIL_INBOX_ID: string;
	DEAL_ALERT_EMAIL_TO: string;
	EARNINGS_ARCHIVE_TOKEN: string;
	EXA_API_KEY: string;
	LLMLAYER_API_KEY: string;
	OPENAI_API_KEY: string;
	TAVILY_API_KEY: string;
	TINYFISH_API_KEY: string;
	EARNINGS_CONTAINER: DurableObjectNamespace<import("./worker").EarningsContainer>;
	EARNINGS_JOB_WORKFLOW: Workflow<Parameters<import("./worker").EarningsJobWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "EarningsContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALPHA_VANTAGE_API_KEY" | "CONVEX_URL" | "DRY_RUN" | "ENVIRONMENT" | "NATIVE_SENDS_ENABLED" | "EMAIL_PROVIDER" | "TINYFISH_LANGUAGE" | "TINYFISH_LOCATION" | "OPENAI_WEB_SEARCH_MODEL" | "EARNINGS_TIME_ZONE" | "SCHEDULE_VERSION" | "RELEASE_TAG" | "AGENTMAIL_API_KEY" | "AGENTMAIL_INBOX_ID" | "DEAL_ALERT_EMAIL_TO" | "EARNINGS_ARCHIVE_TOKEN" | "EXA_API_KEY" | "LLMLAYER_API_KEY" | "OPENAI_API_KEY" | "TAVILY_API_KEY" | "TINYFISH_API_KEY">> {}
}
