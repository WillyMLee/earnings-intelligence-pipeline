const DISPLAY_NAMES: Record<string, string> = {
  ...
  BA: "Boeing", BAC: "Bank of America", BILL: "BILL", BKNG: "Booking Holdings", BLK: "BlackRock",
  ...
  ISRG: "Intuitive Surgical", JNJ: "Johnson & Johnson", JPM: "JPMorgan", KLAC: "KLA", LLY: "Eli Lilly",
  LMT: "Lockheed Martin", LOW: "Lowe's", LRCX: "Lam Research", MA: "Mastercard", MCD: "McDonald's",
  META: "Meta", MNDY: "monday.com", MRK: "Merck", MS: "Morgan Stanley", MSFT: "Microsoft",
