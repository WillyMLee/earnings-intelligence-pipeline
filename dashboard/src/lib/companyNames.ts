const DISPLAY_NAMES: Record<string, string> = {
  ...
  IAS: "Integral Ad Science", ISRG: "Intuitive Surgical", JNJ: "Johnson & Johnson", JPM: "JPMorgan", KLAC: "KLA", KVYO: "Klaviyo", LIME: "Lime", LLY: "Eli Lilly",
  ...
  PEW: "GrabAGun", PFE: "Pfizer", PG: "P&G", PLTR: "Palantir", PSQH: "PSQ Holdings", PUBM: "PubMatic", PYPL: "PayPal", QCOM: "Qualcomm", RDDT: "Reddit", RTX: "RTX",
  S: "SentinelOne", SBUX: "Starbucks", SCHW: "Charles Schwab", SHOP: "Shopify", SKIL: "Skillsoft", SNDK: "Sandisk",
